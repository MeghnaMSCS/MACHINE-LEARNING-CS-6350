...
RF_algo = RandomForestClassifier(random_state=14)
classifierFunc=RandomizedSearchCV(estimator=RF_algo,param_distributions=parameters,cv=5,n_iter=25,
                                  verbose=2,random_state=14,n_jobs=-1)
...
output_data.to_csv("MLsub_RF.csv",index=False)
